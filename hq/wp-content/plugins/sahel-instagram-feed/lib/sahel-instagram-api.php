...
include 'sahel-instagram-helper.php';

/**
 * Class SahelInstagramApi
 */
class SahelInstagramApi {
	...
	const INSTAGRAM_CODE = 'sahel_instagram_code';
	const INSTAGRAM_USER_ID = 'sahel_instagram_user_id';
	const INSTAGRAM_TOKEN = 'sahel_instagram_access_token';
	const INSTAGRAM_TOKEN_LONG_LIVED = 'sahel_instagram_access_token_long_lived';
	const INSTAGRAM_TOKEN_LONG_LIVED_TIME = 'sahel_instagram_access_token_long_lived_time';

	const FACEBOOK_CODE = 'sahel_facebook_code';
	const FACEBOOK_TOKEN = 'sahel_facebook_access_token';

	const CONNECTION_TYPE = 'sahel_connection_type';
	...
	public function __construct() {
		...
		$this->helper = new SahelInstagramHelper();
	}
	 ...
	 *
	 * @see SahelInstagramApi::fetchData()
	 */
	 ...
	 * @return stdClass
	 *
	 * @see SahelInstagramApi::instagramExchangeCodeForToken()
	 */
