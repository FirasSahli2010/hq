...
/**
 * Class SahelInstagramHelper
 */
class SahelInstagramHelper {
	/**
	 * Generates HTML for given image from Instagram feed. Defines sahel_instagram_image_atts filter
	 *
	...
	public function getImageHTML( $image ) {
		...
		$imageAtts = apply_filters( 'sahel_instagram_image_atts',
			array(
