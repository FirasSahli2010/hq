<?php
if ( ! function_exists( 'sahel_elated_init_google_fonts_array' ) ) {
    function sahel_elated_init_google_fonts_array() {
        ...
        $sahel_elated_global_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'sahel_elated_init_google_fonts_array');
}