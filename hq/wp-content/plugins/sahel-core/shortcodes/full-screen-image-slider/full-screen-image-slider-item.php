<?php
namespace SahelCore\CPT\Shortcodes\FullScreenImageSlider;
...
class FullScreenImageSliderItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'      => esc_html__( 'Full Screen Image Slider Item', 'sahel-core' ),
					'base'      => $this->base,
					...
					'params'    => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Content Image Top', 'sahel-core' ),
							'description' => esc_html__( 'Select image from media library', 'sahel-core' )
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_left',
							'heading'     => esc_html__( 'Content Image Left', 'sahel-core' ),
							'description' => esc_html__( 'Select image from media library', 'sahel-core' )
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_right',
							'heading'     => esc_html__( 'Content Image Right', 'sahel-core' ),
							'description' => esc_html__( 'Select image from media library', 'sahel-core' )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'     => esc_html__( 'Subitle Tag', 'sahel-core' ),
							'value'       => array_flip( sahel_elated_get_title_tag( true ) ),
							'save_always' => true,
						...
						array(
							...
							'heading'    => esc_html__( 'Subitle Color', 'sahel-core' ),
							'dependency' => array( 'element' => 'subtitle', 'not_empty' => true )
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = sahel_core_get_shortcode_module_template_part( 'templates/full-screen-image-slider-item', 'full-screen-image-slider', '', $params );
