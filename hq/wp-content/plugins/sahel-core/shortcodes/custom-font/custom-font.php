...
namespace SahelCore\CPT\Shortcodes\CustomFont;
...
class CustomFont implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Custom Font', 'sahel-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							'type'       => 'textfield',
							'param_name' => 'title',
							'heading'    => esc_html__( 'Title Text', 'sahel-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'type_out_effect',
							'heading'     => esc_html__( 'Enable Type Out Effect', 'sahel-core' ),
							'description' => esc_html__( 'Adds a type out effect inside custom font content', 'sahel-core' ),
							'value'       => array_flip( sahel_elated_get_yes_no_select_array( false ) )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'type_out_position',
							'heading'     => esc_html__( 'Position of Type Out Effect', 'sahel-core' ),
							'description' => esc_html__( 'Enter the position of the word after which you would like to display type out effect (e.g. if you would like the type out effect after the 3rd word, you would enter "3")', 'sahel-core' ),
							'dependency'  => array( 'element' => 'type_out_effect', 'value' => array( 'yes' ) )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'typed_color',
							'heading'    => esc_html__( 'Typed Color', 'sahel-core' ),
							'dependency' => array( 'element' => 'type_out_effect', 'value' => array( 'yes' ) )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'typed_ending_1',
							'heading'    => esc_html__( 'Typed Ending Number 1', 'sahel-core' ),
							'dependency' => Array( 'element' => 'type_out_effect', 'value' => array( 'yes' ) )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'typed_ending_2',
							'heading'    => esc_html__( 'Typed Ending Number 2', 'sahel-core' ),
							'dependency' => array( 'element' => 'typed_ending_1', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'typed_ending_3',
							'heading'    => esc_html__( 'Typed Ending Number 3', 'sahel-core' ),
							'dependency' => array( 'element' => 'typed_ending_2', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'typed_ending_4',
							'heading'    => esc_html__( 'Typed Ending Number 4', 'sahel-core' ),
							'dependency' => array( 'element' => 'typed_ending_3', 'not_empty' => true )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'title_break_words',
							'heading'     => esc_html__( 'Position of Line Break', 'sahel-core' ),
							'description' => esc_html__( 'Enter the positions of the words after which you would like to create a line break (e.g. if you would like the line break after the 3rd and 8th words, you would enter "3,8")', 'sahel-core' ),
							'dependency'  => array( 'element' => 'title', 'not_empty' => true )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'disable_break_words',
							'heading'     => esc_html__( 'Disable Line Break for Smaller Screens', 'sahel-core' ),
							'value'       => array_flip( sahel_elated_get_yes_no_select_array( false ) ),
							'save_always' => true,
						...
						array(
							...
							'heading'    => esc_html__( 'Font Family', 'sahel-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'font_size',
							'heading'    => esc_html__( 'Font Size (px or em)', 'sahel-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'line_height',
							'heading'    => esc_html__( 'Line Height (px or em)', 'sahel-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'font_weight',
							'heading'     => esc_html__( 'Font Weight', 'sahel-core' ),
							'value'       => array_flip( sahel_elated_get_font_weight_array( true ) ),
							'save_always' => true
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'font_style',
							'heading'     => esc_html__( 'Font Style', 'sahel-core' ),
							'value'       => array_flip( sahel_elated_get_font_style_array( true ) ),
							'save_always' => true
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'letter_spacing',
							'heading'    => esc_html__( 'Letter Spacing (px or em)', 'sahel-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'text_transform',
							'heading'     => esc_html__( 'Text Transform', 'sahel-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Text Decoration', 'sahel-core' ),
							'value'       => array_flip( sahel_elated_get_text_decorations( true ) ),
							'save_always' => true
						),
						array(
							'type'       => 'colorpicker',
						...
						array(
							...
							'heading'     => esc_html__( 'Text Align', 'sahel-core' ),
							'value'       => array(
								...
								esc_html__( 'Justify', 'sahel-core' ) => 'justify'
							),
							'save_always' => true
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'margin',
							'heading'     => esc_html__( 'Margin (px or %)', 'sahel-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Font Size (px or em)', 'sahel-core' ),
							'group'      => esc_html__( 'Laptops', 'sahel-core' )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'    => esc_html__( 'Font Size (px or em)', 'sahel-core' ),
							'group'      => esc_html__( 'Tablets Landscape', 'sahel-core' )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'    => esc_html__( 'Font Size (px or em)', 'sahel-core' ),
							'group'      => esc_html__( 'Tablets Portrait', 'sahel-core' )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'    => esc_html__( 'Font Size (px or em)', 'sahel-core' ),
							'group'      => esc_html__( 'Mobiles', 'sahel-core' )
						),
						array(
							'type'       => 'textfield',
	...
	public function render( $atts, $content = null ) {
		...
		$html = sahel_core_get_shortcode_module_template_part( 'templates/custom-font', 'custom-font', '', $params );
	...
	private function getHolderStyles( $params ) {
		...
		if ( ! empty( $params['font_size'] ) ) {
			if ( sahel_elated_string_ends_with( $params['font_size'], 'px' ) || sahel_elated_string_ends_with( $params['font_size'], 'em' ) ) {
		...
		if ( ! empty( $params['line_height'] ) ) {
			if ( sahel_elated_string_ends_with( $params['line_height'], 'px' ) || sahel_elated_string_ends_with( $params['line_height'], 'em' ) ) {
		...
		if ( ! empty( $params['letter_spacing'] ) ) {
			if ( sahel_elated_string_ends_with( $params['letter_spacing'], 'px' ) || sahel_elated_string_ends_with( $params['letter_spacing'], 'em' ) ) {
	...
	private function getHolderData( $params ) {
		...
		if ( $params['font_size_1366'] !== '' ) {
			if ( sahel_elated_string_ends_with( $params['font_size_1366'], 'px' ) || sahel_elated_string_ends_with( $params['font_size_1366'], 'em' ) ) {
		...
		if ( $params['font_size_1024'] !== '' ) {
			if ( sahel_elated_string_ends_with( $params['font_size_1024'], 'px' ) || sahel_elated_string_ends_with( $params['font_size_1024'], 'em' ) ) {
		...
		if ( $params['font_size_768'] !== '' ) {
			if ( sahel_elated_string_ends_with( $params['font_size_768'], 'px' ) || sahel_elated_string_ends_with( $params['font_size_768'], 'em' ) ) {
		...
		if ( $params['font_size_680'] !== '' ) {
			if ( sahel_elated_string_ends_with( $params['font_size_680'], 'px' ) || sahel_elated_string_ends_with( $params['font_size_680'], 'em' ) ) {
		...
		if ( $params['line_height_1366'] !== '' ) {
			if ( sahel_elated_string_ends_with( $params['line_height_1366'], 'px' ) || sahel_elated_string_ends_with( $params['line_height_1366'], 'em' ) ) {
		...
		if ( $params['line_height_1024'] !== '' ) {
			if ( sahel_elated_string_ends_with( $params['line_height_1024'], 'px' ) || sahel_elated_string_ends_with( $params['line_height_1024'], 'em' ) ) {
		...
		if ( $params['line_height_768'] !== '' ) {
			if ( sahel_elated_string_ends_with( $params['line_height_768'], 'px' ) || sahel_elated_string_ends_with( $params['line_height_768'], 'em' ) ) {
		...
		if ( $params['line_height_680'] !== '' ) {
			if ( sahel_elated_string_ends_with( $params['line_height_680'], 'px' ) || sahel_elated_string_ends_with( $params['line_height_680'], 'em' ) ) {
	...
	private function getModifiedTitle( $params ) {
		...
		if ( ! empty( $title ) && ( $type_out_effect === 'yes' || ! empty( $title_break_words ) ) ) {
			...
			if ( $type_out_effect === 'yes' && ! empty( $type_out_position ) ) {
				...
				$typed_html = '<span class="eltdf-cf-typed-wrap" ' . sahel_elated_get_inline_style( $typed_styles ) . '><span class="eltdf-cf-typed">';
