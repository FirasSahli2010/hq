<?php
namespace SahelCore\CPT\Shortcodes\Countdown;
...
class Countdown implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Countdown', 'sahel-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'value'      => array(
								...
								esc_html__( 'Light', 'sahel-core' )   => 'eltdf-light-skin',
							),
							'save_always' => true
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'year',
							'heading'     => esc_html__( 'Year', 'sahel-core' ),
							'value'       => array(
								'2018' => '2018',
								'2019' => '2019',
								'2020' => '2020',
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'month',
							'heading'     => esc_html__( 'Month', 'sahel-core' ),
							'value'       => array(
								esc_html__( 'January', 'sahel-core' )   => '1',
								esc_html__( 'February', 'sahel-core' )  => '2',
								esc_html__( 'March', 'sahel-core' )     => '3',
								esc_html__( 'April', 'sahel-core' )     => '4',
								esc_html__( 'May', 'sahel-core' )       => '5',
								esc_html__( 'June', 'sahel-core' )      => '6',
								esc_html__( 'July', 'sahel-core' )      => '7',
								esc_html__( 'August', 'sahel-core' )    => '8',
								esc_html__( 'September', 'sahel-core' ) => '9',
								esc_html__( 'October', 'sahel-core' )   => '10',
								esc_html__( 'November', 'sahel-core' )  => '11',
								esc_html__( 'December', 'sahel-core' )  => '12'
							),
							'save_always' => true
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'day',
							'heading'     => esc_html__( 'Day', 'sahel-core' ),
							'value'       => array(
								'1'  => '1',
								'2'  => '2',
								'3'  => '3',
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'hour',
							'heading'     => esc_html__( 'Hour', 'sahel-core' ),
							'value'       => array(
								'0'  => '0',
								'1'  => '1',
								'2'  => '2',
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'minute',
							'heading'     => esc_html__( 'Minute', 'sahel-core' ),
							'value'       => array(
								'0'  => '0',
								'1'  => '1',
								'2'  => '2',
						...
						array(
							...
							'heading'    => esc_html__( 'Month Label', 'sahel-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'day_label',
							'heading'    => esc_html__( 'Day Label', 'sahel-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'hour_label',
							'heading'    => esc_html__( 'Hour Label', 'sahel-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'minute_label',
							'heading'    => esc_html__( 'Minute Label', 'sahel-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'second_label',
							'heading'    => esc_html__( 'Second Label', 'sahel-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'digit_font_size',
							'heading'    => esc_html__( 'Digit Font Size (px)', 'sahel-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'label_font_size',
							'heading'    => esc_html__( 'Label Font Size (px)', 'sahel-core' )
						)
					)
				)
			);
	...
	public function render( $atts, $content = null ) {
		...
		$html = sahel_core_get_shortcode_module_template_part( 'templates/countdown', 'countdown', '', $params );
