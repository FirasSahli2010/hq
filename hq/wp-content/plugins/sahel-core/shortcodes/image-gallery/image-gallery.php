<?php
namespace SahelCore\CPT\Shortcodes\ImageGallery;
...
class ImageGallery implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Image Gallery', 'sahel-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'type',
							'heading'     => esc_html__( 'Gallery Type', 'sahel-core' ),
							'value'       => array(
								esc_html__( 'Image Grid', 'sahel-core' ) => 'grid',
								esc_html__( 'Masonry', 'sahel-core' )    => 'masonry',
								esc_html__( 'Slider', 'sahel-core' )     => 'slider',
								esc_html__( 'Carousel', 'sahel-core' )   => 'carousel'
							),
							'save_always' => true,
							'admin_label' => true
						),
						array(
							'type'        => 'attach_images',
							'param_name'  => 'images',
							'heading'     => esc_html__( 'Images', 'sahel-core' ),
							'description' => esc_html__( 'Select images from media library', 'sahel-core' )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'image_size',
							'heading'     => esc_html__( 'Image Size', 'sahel-core' ),
							'description' => esc_html__( 'Enter image size. Example: thumbnail, medium, large, full or other sizes defined by current theme. Alternatively enter image size in pixels: 200x100 (Width x Height). Leave empty to use "full" size', 'sahel-core' )
						),
						array(
							'type'        => 'dropdown',
						...
						array(
							...
							'heading'    => esc_html__( 'Image Behavior', 'sahel-core' ),
							'value'      => array(
								esc_html__( 'None', 'sahel-core' )             => '',
								esc_html__( 'Open Lightbox', 'sahel-core' )    => 'lightbox',
								esc_html__( 'Open Custom Link', 'sahel-core' ) => 'custom-link',
								esc_html__( 'Zoom', 'sahel-core' )             => 'zoom',
								esc_html__( 'Grayscale', 'sahel-core' )        => 'grayscale'
							)
						),
						array(
							'type'        => 'textarea',
							'param_name'  => 'custom_links',
							'heading'     => esc_html__( 'Custom Links', 'sahel-core' ),
							'description' => esc_html__( 'Delimit links by comma', 'sahel-core' ),
                        ...
                        array(
                            ...
                            'heading'     => esc_html__( 'Custom Titles', 'sahel-core' ),
                            'description' => esc_html__( 'Delimit titles by comma', 'sahel-core' )
                        ),
						...
						array(
							...
							'heading'     => esc_html__( 'Number Of Visible Items', 'sahel-core' ),
							'value'       => array(
								esc_html__( 'One', 'sahel-core' )   => '1',
								esc_html__( 'Two', 'sahel-core' )   => '2',
								esc_html__( 'Three', 'sahel-core' ) => '3',
								esc_html__( 'Four', 'sahel-core' )  => '4',
								esc_html__( 'Five', 'sahel-core' )  => '5',
								esc_html__( 'Six', 'sahel-core' )   => '6'
							),
							'save_always' => true,
							'dependency'  => array( 'element' => 'type', 'value' => array( 'carousel' ) ),
							'group'       => esc_html__( 'Slider Settings', 'sahel-core' )
						),

                        array(
                            'type'        => 'dropdown',
                            'param_name'  => 'auto_width',
                            'heading'     => esc_html__( 'Enable Auto Width For Images', 'sahel-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Loop', 'sahel-core' ),
							'value'       => array_flip( sahel_elated_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Autoplay', 'sahel-core' ),
							'value'       => array_flip( sahel_elated_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'dependency'  => array( 'element' => 'type', 'value' => array( 'slider', 'carousel' ) ),
							'group'       => esc_html__( 'Slider Settings', 'sahel-core' )
						...
						array(
							...
							'heading'     => esc_html__( 'Slide Duration', 'sahel-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Slide Animation Duration', 'sahel-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Padding', 'sahel-core' ),
							'description' => esc_html__( 'Padding left and right on stage (can see neighbours).', 'sahel-core' ),
							'value'       => array_flip( sahel_elated_get_yes_no_select_array( false ) ),
							'save_always' => true,
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Navigation Arrows', 'sahel-core' ),
							'value'       => array_flip( sahel_elated_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'dependency'  => array( 'element' => 'type', 'value' => array( 'slider', 'carousel' ) ),
							'group'       => esc_html__( 'Slider Settings', 'sahel-core' )
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Pagination', 'sahel-core' ),
							'value'       => array_flip( sahel_elated_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'dependency'  => array( 'element' => 'type', 'value' => array( 'slider', 'carousel' ) ),
							'group'       => esc_html__( 'Slider Settings', 'sahel-core' )
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'slider_pagination_names',
							'heading'     => esc_html__( 'Enable Image Titles as Pagination', 'sahel-core' ),
							'value'       => array_flip( sahel_elated_get_yes_no_select_array( true, true ) ),
							'dependency'  => array( 'element' => 'type', 'value' => array( 'slider' ) ),
							'group'       => esc_html__( 'Slider Settings', 'sahel-core' )
						),
					)
	...
	public function render( $atts, $content = null ) {
        ...
        $params['custom_data']        = $this->getCustomData( $params );
		$params['custom_link_target'] = ! empty( $params['custom_link_target'] ) ? $params['custom_link_target'] : $args['custom_link_target'];
		
		$html = sahel_core_get_shortcode_module_template_part( 'templates/' . $params['type'], 'image-gallery', '', $params );
	...
	private function getSliderData( $params ) {
		...
		$slider_data['data-enable-pagination-names'] = ! empty( $params['slider_pagination_names'] ) ? $params['slider_pagination_names'] : '';
    ...
    private function getCustomData( $params ) {
        $custom_data = array();

        if ( ! empty( $params['custom_data'] ) ) {
            $custom_data = array_map( 'trim', explode( ',', $params['custom_data'] ) );
        }
