    ...
    <div class="eltdf-ig-slider eltdf-owl-slider" <?php echo sahel_elated_get_inline_attrs($slider_data); ?>>
        <?php foreach ($images as $image) { ?>
            <div class="eltdf-ig-image">
                ...
                <a itemprop="image" class="eltdf-ig-lightbox eltdf-block-drag-link"
                   ...
                   title="<?php echo esc_attr($image['title']); ?>">
                    ...
                    <a itemprop="url" class="eltdf-ig-custom-link eltdf-block-drag-link"
                       href="<?php echo esc_url($custom_links[$i]); ?>"
                       target="<?php echo esc_attr($custom_link_target); ?>"
                       title="<?php echo esc_attr($image['title']); ?>" <?php if (!empty($custom_data) && isset($custom_data[$i])) {
                        echo esc_attr($custom_data[$i]);
                    } ?>>
                        <?php } ?>
