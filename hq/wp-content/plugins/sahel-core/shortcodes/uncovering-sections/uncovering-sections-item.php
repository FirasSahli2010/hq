...
class UncoveringSectionsItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'            => esc_html__( 'Uncovering Sections Item', 'sahel-core' ),
					'base'            => $this->base,
					...
					'params'          => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Header Skin', 'sahel-core' ),
							'value'       => array(
								esc_html__( 'Default', 'sahel-core' ) => '',
	...
	public function render( $atts, $content = null ) {
		...
		$html = sahel_core_get_shortcode_module_template_part( 'templates/uncovering-sections-item', 'uncovering-sections', '', $params );
