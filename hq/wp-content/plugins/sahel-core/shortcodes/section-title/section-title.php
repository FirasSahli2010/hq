<?php
namespace SahelCore\CPT\Shortcodes\SectionTitle;
...
class SectionTitle implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Section Title', 'sahel-core' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						...
						array(
							...
							'value'       => array(
								...
								esc_html__( 'Two Columns', 'sahel-core' ) => 'two-columns'
							),
							'save_always' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Title - Text Position', 'sahel-core' ),
							'value'       => array(
								esc_html__( 'Title Left - Text Right', 'sahel-core' ) => 'title-left',
								esc_html__( 'Title Right - Text Left', 'sahel-core' ) => 'title-right'
							),
							'save_always' => true,
						...
						array(
							...
							'heading'     => esc_html__( 'Space Between Columns', 'sahel-core' ),
							'value'       => array(
								esc_html__( 'Normal', 'sahel-core' ) => 'normal',
								esc_html__( 'Small', 'sahel-core' )  => 'small',
								esc_html__( 'Tiny', 'sahel-core' )   => 'tiny'
							),
							'save_always' => true,
							'dependency'  => array( 'element' => 'type', 'value' => array( 'two-columns' ) )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'position',
							'heading'     => esc_html__( 'Horizontal Position', 'sahel-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Holder Side Padding (px or %)', 'sahel-core' )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'title',
						...
						array(
							...
							'group'       => esc_html__( 'Title Style', 'sahel-core' )
						),
						array(
							'type'       => 'colorpicker',
						...
						array(
							...
							'heading'     => esc_html__( 'Words with Bold Font Weight', 'sahel-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Words with Light Font Weight', 'sahel-core' ),
						...
						array(
							'type'        => 'textfield',
							'param_name'  => 'subtitle',
							'heading'     => esc_html__( 'Subitle', 'sahel-core' ),
							'admin_label' => true
						),
						...
						array(
							...
							'heading'     => esc_html__( 'Subtitle Tag', 'sahel-core' ),
							'value'       => array_flip( sahel_elated_get_title_tag( true, array( 'p' => 'p' ) ) ),
							'save_always' => true,
							'dependency'  => array( 'element' => 'subtitle', 'not_empty' => true ),
							'group'       => esc_html__( 'Subtitle Style', 'sahel-core' )
						),
						...
						array(
							...
							'group'       => esc_html__( 'Text Style', 'sahel-core' )
						),
						array(
							'type'       => 'colorpicker',
						...
						array(
							...
							'heading'    => esc_html__( 'Text Font Size (px)', 'sahel-core' ),
							'dependency' => array( 'element' => 'text', 'not_empty' => true ),
							'group'      => esc_html__( 'Text Style', 'sahel-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Text Line Height (px)', 'sahel-core' ),
							'dependency' => array( 'element' => 'text', 'not_empty' => true ),
							'group'      => esc_html__( 'Text Style', 'sahel-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Text Font Weight', 'sahel-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		$html = sahel_core_get_shortcode_module_template_part( 'templates/section-title', 'section-title', '', $params );
