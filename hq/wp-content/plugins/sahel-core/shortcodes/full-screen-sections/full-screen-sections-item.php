<?php
namespace SahelCore\CPT\Shortcodes\FullScreenSections;
...
class FullScreenSectionsItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'            => esc_html__( 'Full Screen Sections Item', 'sahel-core' ),
					'base'            => $this->base,
					...
					'params'          => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Background Image Position', 'sahel-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Background Image Size', 'sahel-core' ),
							'value'       => array(
								esc_html__( 'Cover', 'sahel-core' )   => 'cover',
								esc_html__( 'Contain', 'sahel-core' ) => 'contain',
								esc_html__( 'Inherit', 'sahel-core' ) => 'inherit'
							),
							'save_always' => true,
							'dependency'  => array('item' => 'background_image', 'not_empty' => true)
						),
						...
						array(
							...
							'heading'     => esc_html__( 'Content Horizontal Alignment', 'sahel-core' ),
							'value'       => array(
								esc_html__( 'Default', 'sahel-core' ) => '',
						...
						array(
							...
							'heading'     => esc_html__( 'Header and Navigation Skin', 'sahel-core' ),
							'value'       => array(
								esc_html__( 'Default', 'sahel-core' ) => '',
						...
						array(
							...
							'heading'     => esc_html__('Background Image for Laptops', 'sahel-core'),
							'group'       => esc_html__('Responsiveness', 'sahel-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_tablet',
							'heading'     => esc_html__('Background Image for Tablets - Landscape', 'sahel-core'),
							'group'       => esc_html__('Responsiveness', 'sahel-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_tablet_portrait',
							'heading'     => esc_html__('Background Image for Tablets - Portrait', 'sahel-core'),
							'group'       => esc_html__('Responsiveness', 'sahel-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_mobile',
							'heading'     => esc_html__('Background Image for Mobiles', 'sahel-core'),
							'group'       => esc_html__('Responsiveness', 'sahel-core')
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = sahel_core_get_shortcode_module_template_part( 'templates/full-screen-sections-item', 'full-screen-sections', '', $params );
