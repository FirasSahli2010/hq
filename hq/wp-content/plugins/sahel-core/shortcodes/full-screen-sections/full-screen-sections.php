...
class FullScreenSections implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'      => esc_html__( 'Full Screen Sections', 'sahel-core' ),
					'base'      => $this->base,
					...
					'params'    => array(
						array(
							...
							'heading'     => esc_html__( 'Enable Continuous Scrolling', 'sahel-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Navigation Arrows', 'sahel-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Pagination Dots', 'sahel-core' ),
							'value'       => array_flip( sahel_elated_get_yes_no_select_array( false, true ) ),
							'save_always' => true
						)
					)
	...
	public function render( $atts, $content = null ) {
		...
		$html = sahel_core_get_shortcode_module_template_part( 'templates/full-screen-sections', 'full-screen-sections', '', $params );
