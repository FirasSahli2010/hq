<?php
namespace SahelCore\CPT\Shortcodes\Button;
...
class Button implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Button', 'sahel-core' ),
					'base'                      => $this->base,
					...
					'params'                    => array_merge(
						array(
							...
							array(
								...
								'value'       => array(
									...
									esc_html__( 'Simple', 'sahel-core' )  => 'simple'
								),
								'admin_label' => true
							),
							array(
							...
							array(
								...
								'value'       => esc_html__( 'Button Text', 'sahel-core' ),
								'save_always' => true,
								'admin_label' => true
							),
							array(
						...
						sahel_elated_icon_collections()->getVCParamsArray( array('element' => 'type', 'value' => array( 'solid', 'outline' )), '', true ),
						array(
							array(
								'type'       => 'colorpicker',
								'param_name' => 'color',
								'heading'    => esc_html__( 'Color', 'sahel-core' ),
								'group'      => esc_html__( 'Design Options', 'sahel-core' )
							),
							array(
								'type'       => 'colorpicker',
								'param_name' => 'hover_color',
								'heading'    => esc_html__( 'Hover Color', 'sahel-core' ),
								'group'      => esc_html__( 'Design Options', 'sahel-core' )
							),
							array(
								'type'       => 'colorpicker',
							...
							array(
								...
								'heading'    => esc_html__( 'Font Size (px)', 'sahel-core' ),
								'group'      => esc_html__( 'Design Options', 'sahel-core' )
							),
							array(
								'type'        => 'dropdown',
							...
							array(
								'type'        => 'textfield',
								'param_name'  => 'padding',
								'heading'     => esc_html__( 'Button Padding', 'sahel-core' ),
								'description' => esc_html__( 'Insert padding in format: top right bottom left (e.g. 10px 5px 10px 5px)', 'sahel-core' ),
								'dependency'  => array( 'element' => 'type', 'value' => array( 'solid', 'outline' ) ),
								'group'       => esc_html__( 'Design Options', 'sahel-core' )
							)
						)
	...
	public function render( $atts, $content = null ) {
		...
		return sahel_core_get_shortcode_module_template_part( 'templates/' . $params['html_type'], 'button', '', $params );
	}
	...
	private function getButtonStyles( $params ) {
		...
		if ( ! empty( $params['font_size'] ) ) {
			$styles[] = 'font-size: ' . sahel_elated_filter_px( $params['font_size'] ) . 'px';
		}
