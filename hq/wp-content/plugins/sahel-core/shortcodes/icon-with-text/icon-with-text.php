<?php
namespace SahelCore\CPT\Shortcodes\IconWithText;
...
class IconWithText implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Icon With Text', 'sahel-core' ),
					'base'                      => $this->base,
					...
					'params'                    => array_merge(
						array(
							...
							array(
								...
								'value'       => array(
									esc_html__( 'Icon Left From Text', 'sahel-core' )  => 'icon-left',
									esc_html__( 'Icon Left From Title', 'sahel-core' ) => 'icon-left-from-title',
									esc_html__( 'Icon Top', 'sahel-core' )             => 'icon-top'
								),
								'save_always' => true
							)
						),
						...
						array(
							array(
								...
								'heading'    => esc_html__( 'Custom Icon', 'sahel-core' )
							),
							array(
								'type'       => 'dropdown',
								'param_name' => 'icon_type',
								'heading'    => esc_html__( 'Icon Type', 'sahel-core' ),
								'value'      => array(
								...
								'group'      => esc_html__( 'Icon Settings', 'sahel-core' )
							),
							array(
								'type'       => 'dropdown',
								'param_name' => 'icon_size',
								'heading'    => esc_html__( 'Icon Size', 'sahel-core' ),
								'value'      => array(
									...
									esc_html__( 'Very Large', 'sahel-core' ) => 'eltdf-icon-huge'
								),
								'group'      => esc_html__( 'Icon Settings', 'sahel-core' )
							),
							array(
								...
								'heading'    => esc_html__( 'Custom Icon Size (px)', 'sahel-core' ),
								'group'      => esc_html__( 'Icon Settings', 'sahel-core' )
							),
							array(
								'type'       => 'textfield',
							...
							array(
								...
								'heading'    => esc_html__( 'Icon Hover Color', 'sahel-core' ),
								'group'      => esc_html__( 'Icon Settings', 'sahel-core' )
							),
							array(
								'type'       => 'colorpicker',
								'param_name' => 'icon_background_color',
								'heading'    => esc_html__( 'Icon Background Color', 'sahel-core' ),
								'dependency' => array(
									'element' => 'icon_type',
							...
							array(
								...
								'heading'    => esc_html__( 'Icon Hover Background Color', 'sahel-core' ),
								'dependency' => array(
									'element' => 'icon_type',
									'value'   => array( 'eltdf-square', 'eltdf-circle' )
								),
							...
							array(
								...
								'heading'    => esc_html__( 'Icon Border Color', 'sahel-core' ),
								'dependency' => array(
									'element' => 'icon_type',
									'value'   => array( 'eltdf-square', 'eltdf-circle' )
								),
							...
							array(
								...
								'heading'    => esc_html__( 'Icon Border Hover Color', 'sahel-core' ),
								'dependency' => array(
									'element' => 'icon_type',
									'value'   => array( 'eltdf-square', 'eltdf-circle' )
								),
							...
							array(
								...
								'heading'    => esc_html__( 'Border Width (px)', 'sahel-core' ),
								'dependency' => array(
									'element' => 'icon_type',
									'value'   => array( 'eltdf-square', 'eltdf-circle' )
								),
							...
							array(
								...
								'group'       => esc_html__( 'Text Settings', 'sahel-core' )
							),
							array(
								'type'       => 'colorpicker',
							...
							array(
								...
								'heading'    => esc_html__( 'Text Top Margin (px)', 'sahel-core' ),
								'dependency' => array( 'element' => 'text', 'not_empty' => true ),
								'group'      => esc_html__( 'Text Settings', 'sahel-core' )
							),
							array(
								...
								'description' => esc_html__( 'Set link around icon and title', 'sahel-core' )
							),
							array(
								'type'       => 'dropdown',
								'param_name' => 'target',
							...
							array(
								...
								'heading'     => esc_html__( 'Text Padding (px)', 'sahel-core' ),
								'description' => esc_html__( 'Set left or top padding dependence of type for your text holder. Default value is 13 for left type and 25 for top icon with text type', 'sahel-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		return sahel_core_get_shortcode_module_template_part( 'templates/iwt', 'icon-with-text', $params['type'], $params );
	}
	...
	private function getIconParameters( $params ) {
		...
		if ( empty( $params['custom_icon'] ) ) {
			...
			if ( ! empty( $params['custom_icon_size'] ) ) {
				$params_array['custom_size'] = sahel_elated_filter_px( $params['custom_icon_size'] ) . 'px';
			}
			...
			if ( ! empty( $params['shape_size'] ) ) {
				$params_array['shape_size'] = sahel_elated_filter_px( $params['shape_size'] ) . 'px';
			}
			...
			if ( $params['icon_border_width'] !== '' ) {
				$params_array['border_width'] = sahel_elated_filter_px( $params['icon_border_width'] ) . 'px';
			}
	...
	private function getHolderClasses( $params ) {
		...
		$holderClasses[] = ! empty( $params['link'] ) ? 'eltdf-iwt-with-link' : '';
	...
	private function getContentStyles( $params ) {
		...
		if ( $params['text_padding'] !== '' && $params['type'] === 'icon-left' ) {
			$styles[] = 'padding-left: ' . sahel_elated_filter_px( $params['text_padding'] ) . 'px';
		}
		
		if ( $params['text_padding'] !== '' && $params['type'] === 'icon-top' ) {
			$styles[] = 'padding-top: ' . sahel_elated_filter_px( $params['text_padding'] ) . 'px';
		}
