...
if ( ! class_exists( 'SahelCoreDashboardRestAPI' ) ) {
	 ...
	 */
	class SahelCoreDashboardRestAPI {
		...
		public function __construct() {
			// Init variables
			$this->set_namespace( 'sahel-core/v1' );
			$this->set_route( 'dashboard' );

			// Localize theme's main js script with rest variable
			add_filter( 'sahel_core_dashboard_filter_js_global_variables', array( $this, 'localize_script' ) );
	...
	SahelCoreDashboardRestAPI::get_instance();
}