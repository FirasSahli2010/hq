...
class PortfolioSlider implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Portfolio Slider', 'sahel-core' ),
					'base'     => $this->base,
					...
					'params'   => array(
						array(
							...
							'heading'     => esc_html__( 'Number of Portfolios Items', 'sahel-core' ),
							'admin_label' => true,
							'description' => esc_html__( 'Set number of items for your portfolio slider. Enter -1 to show all', 'sahel-core' )
						),
						array(
							'type'       => 'dropdown',
						...
						array(
							...
							'description' => esc_html__( 'Number of portfolios that are showing at the same time in slider (on smaller screens is responsive so there will be less items shown). Default value is Four', 'sahel-core' ),
							'save_always' => true
						),
						array(
							'type'        => 'dropdown',
						...
						array(
							...
							'description' => esc_html__( 'Set image proportions for your portfolio slider.', 'sahel-core' ),
							'save_always' => true
						),
						array(
							'type'        => 'autocomplete',
						...
						array(
							...
							'heading'    => esc_html__( 'Navigation Skin', 'sahel-core' ),
							'value'      => array(
								esc_html__( 'Default', 'sahel-core' ) => '',
								esc_html__( 'Light', 'sahel-core' )   => 'light',
								esc_html__( 'Dark', 'sahel-core' )    => 'dark'
							),
						...
						array(
							...
							'heading'    => esc_html__( 'Pagination Skin', 'sahel-core' ),
							'value'      => array(
								esc_html__( 'Default', 'sahel-core' ) => '',
								esc_html__( 'Light', 'sahel-core' )   => 'light',
								esc_html__( 'Dark', 'sahel-core' )    => 'dark'
						...
						array(
							...
							'heading'     => esc_html__( 'Pagination Position', 'sahel-core' ),
							'value'       => array(
								esc_html__( 'Below Slider', 'sahel-core' ) => 'below-slider',
								esc_html__( 'On Slider', 'sahel-core' )    => 'on-slider'
							),
							'save_always' => true,
							'dependency'  => array( 'element' => 'enable_pagination', 'value' => array( 'yes' ) ),
							'group'       => esc_html__( 'Slider Settings', 'sahel-core' )
	...
	public function render( $atts, $content = null ) {
		...
		$html = '<div class="eltdf-portfolio-slider-holder">';
			$html .= sahel_elated_execute_shortcode( 'eltdf_portfolio_list', $params );
		$html .= '</div>';
