...
class PortfolioProjectInfo implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Portfolio Project Info', 'sahel-core' ),
					'base'     => $this->getBase(),
					...
					'params'   => array(
						array(
							...
							'heading'     => esc_html__( 'Selected Project', 'sahel-core' ),
							'settings'    => array(
								'sortable'      => true,
								'unique_values' => true
							),
							'description' => esc_html__( 'If you left this field empty then project ID will be of the current page', 'sahel-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'project_info_type',
							'heading'     => esc_html__( 'Project Info Type', 'sahel-core' ),
							'value'       => array(
								esc_html__( 'Title', 'sahel-core' )          => 'title',
								esc_html__( 'Category', 'sahel-core' )       => 'category',
								esc_html__( 'Tag', 'sahel-core' )            => 'tag',
								esc_html__( 'Author', 'sahel-core' )         => 'author',
								esc_html__( 'Date', 'sahel-core' )           => 'date',
								esc_html__( 'Featured Image', 'sahel-core' ) => 'image'
							),
							'admin_label' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Project Title Tag', 'sahel-core' ),
							'value'       => array_flip( sahel_elated_get_title_tag( true, array( 'p' => 'p' ) ) ),
							'description' => esc_html__( 'Set title tag for project title element', 'sahel-core' ),
							'dependency'  => array( 'element' => 'project_info_type', 'value' => array( 'title' ) )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'project_info_title',
							'heading'     => esc_html__( 'Project Info Label', 'sahel-core' ),
							'description' => esc_html__( 'Add project info label before project info element/s', 'sahel-core' )
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'project_info_title_tag',
							'heading'    => esc_html__( 'Project Info Label Tag', 'sahel-core' ),
							'value'      => array_flip( sahel_elated_get_title_tag( true, array( 'p' => 'p', 'span' => esc_html__('Theme Style', 'sahel-core' ) ) ) ),
	...
	public function render( $atts, $content = null ) {
		...
		$project_info_title                = ! empty( $params['project_info_title'] ) ? $params['project_info_title'] : '';
