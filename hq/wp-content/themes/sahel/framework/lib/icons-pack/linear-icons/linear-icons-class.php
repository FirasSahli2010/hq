...
if ( ! function_exists( 'sahel_elated_add_linear_icon_pack' ) ) {
	function sahel_elated_add_linear_icon_pack( $iconCollections ) {
		$iconCollections['linear_icons'] = new SahelElatedClassLinearIcons( 'Linear Icons', 'linear_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'sahel_elated_filter_add_icon_pack_into_collection', 'sahel_elated_add_linear_icon_pack' );
}

if ( ! function_exists( 'sahel_elated_add_linear_icon_pack_option' ) ) {
	function sahel_elated_add_linear_icon_pack_option( $options ) {
		$options['linear_icons'] = esc_html__( 'Linear Icons', 'sahel' );
		
		return $options;
	}
	
	add_filter( 'sahel_elated_filter_add_icon_pack_into_options', 'sahel_elated_add_linear_icon_pack_option' );
}

class SahelElatedClassLinearIcons implements iSahelElatedInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
