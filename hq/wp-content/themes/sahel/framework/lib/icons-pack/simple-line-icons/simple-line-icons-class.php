...
if ( ! function_exists( 'sahel_elated_add_simple_line_icon_pack' ) ) {
	function sahel_elated_add_simple_line_icon_pack( $iconCollections ) {
		$iconCollections['simple_line_icons'] = new SahelElatedClassSimpleLineIcons( 'Simple Line Icons', 'simple_line_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'sahel_elated_filter_add_icon_pack_into_collection', 'sahel_elated_add_simple_line_icon_pack' );
}

if ( ! function_exists( 'sahel_elated_add_simple_line_icon_pack_option' ) ) {
	function sahel_elated_add_simple_line_icon_pack_option( $options ) {
		$options['simple_line_icons'] = esc_html__( 'Simple Line Icons', 'sahel' );
		
		return $options;
	}
	
	add_filter( 'sahel_elated_filter_add_icon_pack_into_options', 'sahel_elated_add_simple_line_icon_pack_option' );
	add_filter( 'sahel_elated_filter_add_icon_pack_into_social_options', 'sahel_elated_add_simple_line_icon_pack_option' );
}

class SahelElatedClassSimpleLineIcons implements iSahelElatedInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'sahel'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'sahel'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'sahel'),
            'icon-social-facebook'    => esc_html__('Facebook', 'sahel'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'sahel'),
            'icon-social-github'      => esc_html__('Github', 'sahel'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'sahel'),
            'icon-social-instagram'   => esc_html__('Instagram', 'sahel'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'sahel'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'sahel'),
            'icon-social-reddit'      => esc_html__('Reddit', 'sahel'),
            'icon-social-skype'       => esc_html__('Skype', 'sahel'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'sahel'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'sahel'),
            'icon-social-spotify'     => esc_html__('Spotify', 'sahel'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'sahel'),
            'icon-social-twitter'     => esc_html__('Twitter', 'sahel'),
            'icon-social-youtube'     => esc_html__('Youtube', 'sahel')
        );
    }
