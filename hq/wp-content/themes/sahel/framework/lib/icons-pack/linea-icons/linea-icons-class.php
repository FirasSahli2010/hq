...
if ( ! function_exists( 'sahel_elated_add_linea_icon_pack' ) ) {
	function sahel_elated_add_linea_icon_pack( $iconCollections ) {
		$iconCollections['linea_icons'] = new SahelElatedClassLineaIcons( 'Linea Icons', 'linea_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'sahel_elated_filter_add_icon_pack_into_collection', 'sahel_elated_add_linea_icon_pack' );
}

if ( ! function_exists( 'sahel_elated_add_linea_icon_pack_option' ) ) {
	function sahel_elated_add_linea_icon_pack_option( $options ) {
		$options['linea_icons'] = esc_html__( 'Linea Icons', 'sahel' );
		
		return $options;
	}
	
	add_filter( 'sahel_elated_filter_add_icon_pack_into_options', 'sahel_elated_add_linea_icon_pack_option' );
}

class SahelElatedClassLineaIcons implements iSahelElatedInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
