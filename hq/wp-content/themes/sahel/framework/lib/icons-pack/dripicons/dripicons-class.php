...
if ( ! function_exists( 'sahel_elated_add_dripicons_icon_pack' ) ) {
	function sahel_elated_add_dripicons_icon_pack( $iconCollections ) {
		$iconCollections['dripicons'] = new SahelElatedClassDripicons( 'Dripicons', 'dripicon' );
		
		return $iconCollections;
	}
	
	add_filter( 'sahel_elated_filter_add_icon_pack_into_collection', 'sahel_elated_add_dripicons_icon_pack' );
}

if ( ! function_exists( 'sahel_elated_add_dripicons_icon_pack_option' ) ) {
	function sahel_elated_add_dripicons_icon_pack_option( $options ) {
		$options['dripicons'] = esc_html__( 'Dripicons', 'sahel' );
		
		return $options;
	}
	
	add_filter( 'sahel_elated_filter_add_icon_pack_into_options', 'sahel_elated_add_dripicons_icon_pack_option' );
}

class SahelElatedClassDripicons implements iSahelElatedInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
