...
if ( ! function_exists( 'sahel_elated_add_font_awesome_icon_pack' ) ) {
	function sahel_elated_add_font_awesome_icon_pack( $iconCollections ) {
		$iconCollections['font_awesome'] = new SahelElatedClassIconsFontAwesome( 'Font Awesome', 'fa_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'sahel_elated_filter_add_icon_pack_into_collection', 'sahel_elated_add_font_awesome_icon_pack' );
}

if ( ! function_exists( 'sahel_elated_add_font_awesome_icon_pack_option' ) ) {
	function sahel_elated_add_font_awesome_icon_pack_option( $options ) {
		$options['font_awesome'] = esc_html__( 'Font Awesome', 'sahel' );
		
		return $options;
	}
	
	add_filter( 'sahel_elated_filter_add_icon_pack_into_options', 'sahel_elated_add_font_awesome_icon_pack_option' );
	add_filter( 'sahel_elated_filter_add_icon_pack_into_social_options', 'sahel_elated_add_font_awesome_icon_pack_option' );
}

class SahelElatedClassIconsFontAwesome implements iSahelElatedInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
