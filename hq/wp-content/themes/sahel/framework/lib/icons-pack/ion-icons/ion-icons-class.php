...
if ( ! function_exists( 'sahel_elated_add_ion_icon_pack' ) ) {
	function sahel_elated_add_ion_icon_pack( $iconCollections ) {
		$iconCollections['ion_icons'] = new SahelElatedClassIonIcons( 'Ion Icons', 'ion_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'sahel_elated_filter_add_icon_pack_into_collection', 'sahel_elated_add_ion_icon_pack' );
}

if ( ! function_exists( 'sahel_elated_add_ion_icon_pack_option' ) ) {
	function sahel_elated_add_ion_icon_pack_option( $options ) {
		$options['ion_icons'] = esc_html__( 'Ion Icons', 'sahel' );
		
		return $options;
	}
	
	add_filter( 'sahel_elated_filter_add_icon_pack_into_options', 'sahel_elated_add_ion_icon_pack_option' );
	add_filter( 'sahel_elated_filter_add_icon_pack_into_social_options', 'sahel_elated_add_ion_icon_pack_option' );
}

class SahelElatedClassIonIcons implements iSahelElatedInterfaceIconCollection {
	public $icons;
	public $socialIcons;
    public $title;
	public $param;
