...
/*
   Class: SahelElatedClassDashboardForm
   A class that initializes Elated Dashboard Container
*/
class SahelElatedClassDashboardForm implements iSahelElatedInterfaceLayoutNode, iSahelElatedInterfaceRender {
	public $children;
	public $name;
	public $form_id;
	public $form_method;
	...
	public function render($factory) {
		...
		<form method="<?php echo esc_attr($this->form_method);?>" id="<?php echo esc_attr($this->form_id);?>" class="<?php echo esc_attr($action_class)?>" data-action="<?php echo esc_attr($this->form_action);?>">
			...
			if ( sahel_elated_core_plugin_installed() ) {
				echo sahel_elated_get_button_html( array(
...
/*
   Class: SahelElatedClassDashboardGroup
   A class that initializes SahelElatedClass Group Field
*/
class SahelElatedClassDashboardGroup implements iSahelElatedInterfaceLayoutNode, iSahelElatedInterfaceRender{
	public $children;
	public $name;
	public $title;
	public $description;
...
/*
   Class: SahelElatedClassDashboardTitle
   A class that initializes Dashboard Title
*/
class SahelElatedClassDashboardTitle implements iSahelElatedInterfaceRender {
	private $name;
	private $title;
...
/*
   Class: SahelElatedClassDashboardField
   A class that initializes SahelElatedClass Front Field
*/

class SahelElatedClassDashboardField implements iSahelElatedInterfaceRender {
	private $type;
	private $name;
	private $label;
	private $description;
...
abstract class SahelElatedClassDashboardFieldType {
	abstract public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = "" );
}

class SahelElatedClassDashboardFieldText extends SahelElatedClassDashboardFieldType {
...
class SahelElatedClassDashboardFieldTextArea extends SahelElatedClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
...
class SahelElatedClassDashboardFieldImage extends SahelElatedClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
        $class = '';
			...
			<div class="eltdf-dashboard-gallery-holder">
				<ul class="eltdf-dashboard-gallery-images-holder">
					<?php if ( isset($value_html) ) {
                        echo sahel_elated_get_module_part( $value_html );
					} ?>
				</ul>
				<div class="eltdf-dashboard-gallery-uploader">
					<?php 
					if ( sahel_membership_theme_installed() ) {
						echo sahel_elated_get_button_html( array(
							'text'      => esc_html__( 'Upload', 'sahel' ),
							'custom_class' => 'eltdf-dashboard-gallery-upload'
						) );
					} else {
						echo '<a itemprop="url" href="#" class="eltdf-btn eltdf-btn-medium eltdf-btn-solid eltdf-dashboard-gallery-upload"><span class="eltdf-btn-text">' . esc_html__( 'Upload', 'sahel' ) . '</span></a>';
					} ?>
					...
					<?php if ($value !== '' && $value !== false) { ?>
						<button class="eltdf-btn eltdf-btn-solid eltdf-dashboard-remove-image"><?php esc_html_e('Remove Media','sahel'); ?></button>
					<?php } ?>
				</div>
			</div>
		</div>
...
class SahelElatedClassDashboardFieldGallery extends SahelElatedClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
        $class = '';
...
class SahelElatedClassDashboardFieldSelect extends SahelElatedClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
        $class = '';
...
class SahelElatedClassDashboardFieldDate extends SahelElatedClassFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
        if (!empty($repeat) && array_key_exists('name', $repeat) && array_key_exists('index', $repeat)) {
			$id		= $name . '-' . $repeat['index'];
			$name	= $repeat['name'] . '['.$repeat['index'].']['. $name .']';
...
class SahelElatedClassDashboardFieldIcon extends SahelElatedClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$options           = sahel_elated_icon_collections()->getIconCollectionsEmpty();
...
class SahelElatedClassDashboardFieldColor extends SahelElatedClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
        if (!empty($repeat) && array_key_exists('name', $repeat) && array_key_exists('index', $repeat)) {
			$id		= $name . '-' . $repeat['index'];
			$name	= $repeat['name'] . '['.$repeat['index'].']['. $name .']';
...
class SahelElatedClassDashboardFieldCheckBoxGroup extends SahelElatedClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
...
class SahelElatedClassDashboardFieldAddress extends SahelElatedClassFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
		if ( isset( $args["col_width"] ) ) {
			$col_width = $args["col_width"];
...
class SahelElatedClassDashboardRepeater implements iSahelElatedInterfaceRender {
	private $label;
	private $description;
	private $name;
	private $fields;
			...
			<?php if ($this->table_layout) { ?>
				<div class="eltdf-dashboard-repeater-table-heading">
					<div class="eltdf-dashboard-repeater-fields-holder">
						<div class="eltdf-dashboard-repeater-table-cell eltdf-dashboard-repeater-sort"><?php esc_html_e( 'Order', 'sahel' ) ?></div>
						...
						<div class="eltdf-dashboard-repeater-table-cell eltdf-dashboard-repeater-remove"><?php esc_html_e( 'Remove', 'sahel' ) ?></div>
					</div>
				</div>
			<?php } ?>
...
class SahelElatedClassDashboardFieldFactory {
	public function render( $field_type, $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array()) {
		switch ( strtolower( $field_type ) ) {
			case 'text':
				$field = new SahelElatedClassDashboardFieldText();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'textarea':
				$field = new SahelElatedClassDashboardFieldTextArea();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'date':
				$field = new SahelElatedClassDashboardFieldDate();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'image':
				$field = new SahelElatedClassDashboardFieldImage();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'gallery':
				$field = new SahelElatedClassDashboardFieldGallery();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'select':
				$field = new SahelElatedClassDashboardFieldSelect();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'icon':
				$field = new SahelElatedClassDashboardFieldIcon();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'color':
				$field = new SahelElatedClassDashboardFieldColor();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'checkboxgroup':
				$field = new SahelElatedClassDashboardFieldCheckBoxGroup();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'address':
				$field = new SahelElatedClassDashboardFieldAddress();
